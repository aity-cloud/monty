...
*/}}
{{- define "monty.labels" -}}
helm.sh/chart: {{ include "monty.chart" . }}
...
app.kubernetes.io/name: {{ include "monty.name" . }}
...
{{- default (include "monty.fullname" .) .Values.serviceAccount.name }}
{{- else }}
