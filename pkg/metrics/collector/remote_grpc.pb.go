...
func (c *remoteCollectorClient) GetMetrics(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*v1.MetricsData, error) {
	...
	err := c.cc.Invoke(ctx, RemoteCollector_GetMetrics_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedRemoteCollectorServer should be embedded to have
...
func (UnimplementedRemoteCollectorServer) testEmbeddedByValue() {}
...
func RegisterRemoteCollectorServer(s grpc.ServiceRegistrar, srv RemoteCollectorServer) {
	// If the following call panics, it indicates UnimplementedRemoteCollectorServer was
...
var RemoteCollector_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "github.com/aity-cloud/monty/pkg/metrics/collector/remote.proto",
}
