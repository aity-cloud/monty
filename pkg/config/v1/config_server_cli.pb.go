...
func BuildGatewayConfigCmd() *cobra.Command {
	...
	cliutil.AddSubcommands(cmd, append([]*cobra.Command{
		...
		BuildGatewayConfigWatchReactiveCmd(),
...
func BuildGatewayConfigWatchReactiveCmd() *cobra.Command {
	in := &v1.ReactiveWatchRequest{}
	cmd := &cobra.Command{
		Use:   "watch",
		Short: "",
		Long: `
...
`[1:],
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			response, err := client.WatchReactive(cmd.Context(), in)
			if err != nil {
				return err
			}
