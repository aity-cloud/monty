...
const file_github_com_aity_cloud_monty_pkg_plugins_driverutil_types_proto_rawDesc = "" +
	"\n" +
	">github.com/aity-cloud/monty/pkg/plugins/driverutil/types.proto\x12\n" +
	"driverutil\x1a)github.com/kralicky/codegen/cli/cli.proto\x1a7github.com/aity-cloud/monty/pkg/apis/core/v1/core.proto\"@\n" +
	"\n" +
	"GetRequest\x122\n" +
	...
	"\n" +
	"\x06Failed\x10\x03B:\x82\xc0\f\x02\b\x01Z2github.com/aity-cloud/monty/pkg/plugins/driverutilb\x06proto3"

var (
	file_github_com_aity_cloud_monty_pkg_plugins_driverutil_types_proto_rawDescOnce sync.Once
	file_github_com_aity_cloud_monty_pkg_plugins_driverutil_types_proto_rawDescData []byte
)
...
func file_github_com_aity_cloud_monty_pkg_plugins_driverutil_types_proto_rawDescGZIP() []byte {
	file_github_com_aity_cloud_monty_pkg_plugins_driverutil_types_proto_rawDescOnce.Do(func() {
		file_github_com_aity_cloud_monty_pkg_plugins_driverutil_types_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_aity_cloud_monty_pkg_plugins_driverutil_types_proto_rawDesc), len(file_github_com_aity_cloud_monty_pkg_plugins_driverutil_types_proto_rawDesc)))
	})
...
var file_github_com_aity_cloud_monty_pkg_plugins_driverutil_types_proto_goTypes = []any{
...
func file_github_com_aity_cloud_monty_pkg_plugins_driverutil_types_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_aity_cloud_monty_pkg_plugins_driverutil_types_proto_rawDesc), len(file_github_com_aity_cloud_monty_pkg_plugins_driverutil_types_proto_rawDesc)),
			NumEnums:      5,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
