...
import (
	...
	_ "github.com/aity-cloud/monty/pkg/ident/supportagent"
	"github.com/aity-cloud/monty/pkg/keyring"
	"github.com/aity-cloud/monty/pkg/logger"
	"github.com/aity-cloud/monty/pkg/supportagent"
	supportagentconfig "github.com/aity-cloud/monty/pkg/supportagent/config"
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			if configFile == "" {
				...
				case errors.Is(err, config.ErrConfigNotFound):
					wd, _ := os.Getwd()
					agentlg.Info(fmt.Sprintf(`could not find a config file in ["%s", "$home/.monty], and --config was not given`, wd))
				default:
					agentlg.With(
						logger.Err(err),
