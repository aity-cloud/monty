...
const file_github_com_aity_cloud_monty_pkg_apis_control_v1_local_proto_rawDesc = "" +
	"\n" +
	";github.com/aity-cloud/monty/pkg/apis/control/v1/local.proto\x12\acontrol\x1a\x1bgoogle/protobuf/empty.proto\x1a7github.com/aity-cloud/monty/pkg/apis/core/v1/core.proto\x1a*github.com/kralicky/totem/extensions.proto2E\n" +
	"\bIdentity\x121\n" +
	"\x06Whoami\x12\x16.google.protobuf.Empty\x1a\x0f.core.Reference\x1a\x06\x92\xf1\x04\x02\b\x01B1Z/github.com/aity-cloud/monty/pkg/apis/control/v1b\x06proto3"

var file_github_com_aity_cloud_monty_pkg_apis_control_v1_local_proto_goTypes = []any{
...
func file_github_com_aity_cloud_monty_pkg_apis_control_v1_local_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_aity_cloud_monty_pkg_apis_control_v1_local_proto_rawDesc), len(file_github_com_aity_cloud_monty_pkg_apis_control_v1_local_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
