...
const file_github_com_aity_cloud_monty_pkg_apis_control_v1_remote_proto_rawDesc = "" +
	"\n" +
	"<github.com/aity-cloud/monty/pkg/apis/control/v1/remote.proto\x12\acontrol\x1a*github.com/kralicky/totem/extensions.proto\x1a7github.com/aity-cloud/monty/pkg/apis/core/v1/core.proto\x1a\x1bgoogle/protobuf/empty.proto\"K\n" +
	"\vSyncResults\x12<\n" +
	...
	"\n" +
	"UpdateSync\x12=\n" +
	"\fSyncManifest\x12\x17.control.UpdateManifest\x1a\x14.control.SyncResultsB1Z/github.com/aity-cloud/monty/pkg/apis/control/v1b\x06proto3"

var (
	file_github_com_aity_cloud_monty_pkg_apis_control_v1_remote_proto_rawDescOnce sync.Once
	file_github_com_aity_cloud_monty_pkg_apis_control_v1_remote_proto_rawDescData []byte
)
...
func file_github_com_aity_cloud_monty_pkg_apis_control_v1_remote_proto_rawDescGZIP() []byte {
	file_github_com_aity_cloud_monty_pkg_apis_control_v1_remote_proto_rawDescOnce.Do(func() {
		file_github_com_aity_cloud_monty_pkg_apis_control_v1_remote_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_aity_cloud_monty_pkg_apis_control_v1_remote_proto_rawDesc), len(file_github_com_aity_cloud_monty_pkg_apis_control_v1_remote_proto_rawDesc)))
	})
...
var file_github_com_aity_cloud_monty_pkg_apis_control_v1_remote_proto_goTypes = []any{
...
func file_github_com_aity_cloud_monty_pkg_apis_control_v1_remote_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_aity_cloud_monty_pkg_apis_control_v1_remote_proto_rawDesc), len(file_github_com_aity_cloud_monty_pkg_apis_control_v1_remote_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   3,
