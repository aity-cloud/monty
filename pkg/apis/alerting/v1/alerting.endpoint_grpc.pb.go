...
func (c *alertEndpointsClient) CreateAlertEndpoint(ctx context.Context, in *AlertEndpoint, opts ...grpc.CallOption) (*v1.Reference, error) {
	...
	err := c.cc.Invoke(ctx, AlertEndpoints_CreateAlertEndpoint_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *alertEndpointsClient) GetAlertEndpoint(ctx context.Context, in *v1.Reference, opts ...grpc.CallOption) (*AlertEndpoint, error) {
	...
	err := c.cc.Invoke(ctx, AlertEndpoints_GetAlertEndpoint_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *alertEndpointsClient) ToggleNotifications(ctx context.Context, in *ToggleRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, AlertEndpoints_ToggleNotifications_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *alertEndpointsClient) ListAlertEndpoints(ctx context.Context, in *ListAlertEndpointsRequest, opts ...grpc.CallOption) (*AlertEndpointList, error) {
	...
	err := c.cc.Invoke(ctx, AlertEndpoints_ListAlertEndpoints_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *alertEndpointsClient) UpdateAlertEndpoint(ctx context.Context, in *UpdateAlertEndpointRequest, opts ...grpc.CallOption) (*ConditionReferenceList, error) {
	...
	err := c.cc.Invoke(ctx, AlertEndpoints_UpdateAlertEndpoint_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *alertEndpointsClient) DeleteAlertEndpoint(ctx context.Context, in *DeleteAlertEndpointRequest, opts ...grpc.CallOption) (*ConditionReferenceList, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ConditionReferenceList)
	err := c.cc.Invoke(ctx, AlertEndpoints_DeleteAlertEndpoint_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedAlertEndpointsServer should be embedded to have
...
func (UnimplementedAlertEndpointsServer) CreateAlertEndpoint(context.Context, *AlertEndpoint) (*v1.Reference, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateAlertEndpoint not implemented")
}
func (UnimplementedAlertEndpointsServer) GetAlertEndpoint(context.Context, *v1.Reference) (*AlertEndpoint, error) {
	return nil, status.Error(codes.Unimplemented, "method GetAlertEndpoint not implemented")
}
func (UnimplementedAlertEndpointsServer) ToggleNotifications(context.Context, *ToggleRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method ToggleNotifications not implemented")
}
func (UnimplementedAlertEndpointsServer) ListAlertEndpoints(context.Context, *ListAlertEndpointsRequest) (*AlertEndpointList, error) {
	return nil, status.Error(codes.Unimplemented, "method ListAlertEndpoints not implemented")
}
func (UnimplementedAlertEndpointsServer) UpdateAlertEndpoint(context.Context, *UpdateAlertEndpointRequest) (*ConditionReferenceList, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateAlertEndpoint not implemented")
}
func (UnimplementedAlertEndpointsServer) DeleteAlertEndpoint(context.Context, *DeleteAlertEndpointRequest) (*ConditionReferenceList, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteAlertEndpoint not implemented")
}
func (UnimplementedAlertEndpointsServer) testEmbeddedByValue() {}
...
func RegisterAlertEndpointsServer(s grpc.ServiceRegistrar, srv AlertEndpointsServer) {
	// If the following call panics, it indicates UnimplementedAlertEndpointsServer was
