...
const file_github_com_aity_cloud_monty_pkg_apis_capability_v1_capability_proto_rawDesc = "" +
	"\n" +
	"Cgithub.com/aity-cloud/monty/pkg/apis/capability/v1/capability.proto\x12\n" +
	"capability\x1a)github.com/kralicky/codegen/cli/cli.proto\x1a*github.com/kralicky/totem/extensions.proto\x1a7github.com/aity-cloud/monty/pkg/apis/core/v1/core.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x87\x01\n" +
	"\aDetails\x12\x12\n" +
	...
	"\tListRoles\x12\x16.google.protobuf.Empty\x1a\x0e.core.RoleListB:\x82\xc0\f\x02\b\x01Z2github.com/aity-cloud/monty/pkg/apis/capability/v1b\x06proto3"

var (
	file_github_com_aity_cloud_monty_pkg_apis_capability_v1_capability_proto_rawDescOnce sync.Once
	file_github_com_aity_cloud_monty_pkg_apis_capability_v1_capability_proto_rawDescData []byte
)
...
func file_github_com_aity_cloud_monty_pkg_apis_capability_v1_capability_proto_rawDescGZIP() []byte {
	file_github_com_aity_cloud_monty_pkg_apis_capability_v1_capability_proto_rawDescOnce.Do(func() {
		file_github_com_aity_cloud_monty_pkg_apis_capability_v1_capability_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_aity_cloud_monty_pkg_apis_capability_v1_capability_proto_rawDesc), len(file_github_com_aity_cloud_monty_pkg_apis_capability_v1_capability_proto_rawDesc)))
	})
...
var file_github_com_aity_cloud_monty_pkg_apis_capability_v1_capability_proto_goTypes = []any{
...
func file_github_com_aity_cloud_monty_pkg_apis_capability_v1_capability_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_aity_cloud_monty_pkg_apis_capability_v1_capability_proto_rawDesc), len(file_github_com_aity_cloud_monty_pkg_apis_capability_v1_capability_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   3,
