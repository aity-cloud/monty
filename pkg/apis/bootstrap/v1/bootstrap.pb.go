...
const file_github_com_aity_cloud_monty_pkg_apis_bootstrap_v1_bootstrap_proto_rawDesc = "" +
	"\n" +
	"Agithub.com/aity-cloud/monty/pkg/apis/bootstrap/v1/bootstrap.proto\x12\tbootstrap\"\x16\n" +
	...
	"\x04Auth\x12\x1f.bootstrap.BootstrapAuthRequest\x1a .bootstrap.BootstrapAuthResponseB3Z1github.com/aity-cloud/monty/pkg/apis/bootstrap/v1b\x06proto3"

var (
	file_github_com_aity_cloud_monty_pkg_apis_bootstrap_v1_bootstrap_proto_rawDescOnce sync.Once
	file_github_com_aity_cloud_monty_pkg_apis_bootstrap_v1_bootstrap_proto_rawDescData []byte
)
...
func file_github_com_aity_cloud_monty_pkg_apis_bootstrap_v1_bootstrap_proto_rawDescGZIP() []byte {
	file_github_com_aity_cloud_monty_pkg_apis_bootstrap_v1_bootstrap_proto_rawDescOnce.Do(func() {
		file_github_com_aity_cloud_monty_pkg_apis_bootstrap_v1_bootstrap_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_aity_cloud_monty_pkg_apis_bootstrap_v1_bootstrap_proto_rawDesc), len(file_github_com_aity_cloud_monty_pkg_apis_bootstrap_v1_bootstrap_proto_rawDesc)))
	})
...
var file_github_com_aity_cloud_monty_pkg_apis_bootstrap_v1_bootstrap_proto_goTypes = []any{
...
func file_github_com_aity_cloud_monty_pkg_apis_bootstrap_v1_bootstrap_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_aity_cloud_monty_pkg_apis_bootstrap_v1_bootstrap_proto_rawDesc), len(file_github_com_aity_cloud_monty_pkg_apis_bootstrap_v1_bootstrap_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
