...
const (
	Bootstrap_Join_FullMethodName = "/bootstrap.v2.Bootstrap/Join"
	Bootstrap_Auth_FullMethodName = "/bootstrap.v2.Bootstrap/Auth"
)
...
func (c *bootstrapClient) Join(ctx context.Context, in *BootstrapJoinRequest, opts ...grpc.CallOption) (*BootstrapJoinResponse, error) {
	...
	err := c.cc.Invoke(ctx, Bootstrap_Join_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bootstrapClient) Auth(ctx context.Context, in *BootstrapAuthRequest, opts ...grpc.CallOption) (*BootstrapAuthResponse, error) {
	...
	err := c.cc.Invoke(ctx, Bootstrap_Auth_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
