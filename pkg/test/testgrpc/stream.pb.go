...
const file_github_com_aity_cloud_monty_pkg_test_testgrpc_stream_proto_rawDesc = "" +
	"\n" +
	":github.com/aity-cloud/monty/pkg/test/testgrpc/stream.proto\x12\x0ftestgrpc.stream\")\n" +
	"\rStreamRequest\x12\x18\n" +
	"\arequest\x18\x01 \x01(\tR\arequest\",\n" +
	"\x0eStreamResponse\x12\x1a\n" +
	"\bresponse\x18\x01 \x01(\tR\bresponse2^\n" +
	"\rStreamService\x12M\n" +
	"\x06Stream\x12\x1e.testgrpc.stream.StreamRequest\x1a\x1f.testgrpc.stream.StreamResponse(\x010\x01B/Z-github.com/aity-cloud/monty/pkg/test/testgrpcb\x06proto3"

var (
	file_github_com_aity_cloud_monty_pkg_test_testgrpc_stream_proto_rawDescOnce sync.Once
	file_github_com_aity_cloud_monty_pkg_test_testgrpc_stream_proto_rawDescData []byte
)
...
func file_github_com_aity_cloud_monty_pkg_test_testgrpc_stream_proto_rawDescGZIP() []byte {
	file_github_com_aity_cloud_monty_pkg_test_testgrpc_stream_proto_rawDescOnce.Do(func() {
		file_github_com_aity_cloud_monty_pkg_test_testgrpc_stream_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_aity_cloud_monty_pkg_test_testgrpc_stream_proto_rawDesc), len(file_github_com_aity_cloud_monty_pkg_test_testgrpc_stream_proto_rawDesc)))
	})
...
var file_github_com_aity_cloud_monty_pkg_test_testgrpc_stream_proto_goTypes = []any{
...
func file_github_com_aity_cloud_monty_pkg_test_testgrpc_stream_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_aity_cloud_monty_pkg_test_testgrpc_stream_proto_rawDesc), len(file_github_com_aity_cloud_monty_pkg_test_testgrpc_stream_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
