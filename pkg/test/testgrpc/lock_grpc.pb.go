...
func (c *testLockerClient) Lock(ctx context.Context, in *LockRequest, opts ...grpc.CallOption) (*LockResponse, error) {
	...
	err := c.cc.Invoke(ctx, TestLocker_Lock_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *testLockerClient) TryLock(ctx context.Context, in *LockRequest, opts ...grpc.CallOption) (*LockResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LockResponse)
	err := c.cc.Invoke(ctx, TestLocker_TryLock_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *testLockerClient) ListLocks(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListLocksResponse, error) {
	...
	err := c.cc.Invoke(ctx, TestLocker_ListLocks_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *testLockerClient) Unlock(ctx context.Context, in *UnlockRequest, opts ...grpc.CallOption) (*UnlockResponse, error) {
	...
	err := c.cc.Invoke(ctx, TestLocker_Unlock_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedTestLockerServer should be embedded to have
...
func (UnimplementedTestLockerServer) testEmbeddedByValue() {}
...
func RegisterTestLockerServer(s grpc.ServiceRegistrar, srv TestLockerServer) {
	// If the following call panics, it indicates UnimplementedTestLockerServer was
