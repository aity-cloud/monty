...
const file_github_com_aity_cloud_monty_pkg_test_testdata_plugins_ext_ext_proto_rawDesc = "" +
	...
	"\x04Ext2\x12(\n" +
	"\x03Foo\x12\x0f.ext.FooRequest\x1a\x10.ext.FooResponseBC\x82\xc0\f\x04\b\x01\x18\x01Z9github.com/aity-cloud/monty/pkg/test/testdata/plugins/extb\x06proto3"

var (
	file_github_com_aity_cloud_monty_pkg_test_testdata_plugins_ext_ext_proto_rawDescOnce sync.Once
	file_github_com_aity_cloud_monty_pkg_test_testdata_plugins_ext_ext_proto_rawDescData []byte
)
...
func file_github_com_aity_cloud_monty_pkg_test_testdata_plugins_ext_ext_proto_rawDescGZIP() []byte {
	file_github_com_aity_cloud_monty_pkg_test_testdata_plugins_ext_ext_proto_rawDescOnce.Do(func() {
		file_github_com_aity_cloud_monty_pkg_test_testdata_plugins_ext_ext_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_aity_cloud_monty_pkg_test_testdata_plugins_ext_ext_proto_rawDesc), len(file_github_com_aity_cloud_monty_pkg_test_testdata_plugins_ext_ext_proto_rawDesc)))
	})
...
var file_github_com_aity_cloud_monty_pkg_test_testdata_plugins_ext_ext_proto_goTypes = []any{
...
func file_github_com_aity_cloud_monty_pkg_test_testdata_plugins_ext_ext_proto_init() {
	...
	file_github_com_aity_cloud_monty_pkg_test_testdata_plugins_ext_ext_proto_msgTypes[8].OneofWrappers = []any{}
	file_github_com_aity_cloud_monty_pkg_test_testdata_plugins_ext_ext_proto_msgTypes[9].OneofWrappers = []any{}
	file_github_com_aity_cloud_monty_pkg_test_testdata_plugins_ext_ext_proto_msgTypes[10].OneofWrappers = []any{}
	file_github_com_aity_cloud_monty_pkg_test_testdata_plugins_ext_ext_proto_msgTypes[11].OneofWrappers = []any{}
	file_github_com_aity_cloud_monty_pkg_test_testdata_plugins_ext_ext_proto_msgTypes[13].OneofWrappers = []any{}
	file_github_com_aity_cloud_monty_pkg_test_testdata_plugins_ext_ext_proto_msgTypes[15].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_aity_cloud_monty_pkg_test_testdata_plugins_ext_ext_proto_rawDesc), len(file_github_com_aity_cloud_monty_pkg_test_testdata_plugins_ext_ext_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   25,
			NumExtensions: 0,
			NumServices:   3,
