...
func (c *remoteTopologyClient) Push(ctx context.Context, in *Payload, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, RemoteTopology_Push_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *remoteTopologyClient) SyncTopology(ctx context.Context, in *Payload, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, RemoteTopology_SyncTopology_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedRemoteTopologyServer should be embedded to have
...
func (UnimplementedRemoteTopologyServer) testEmbeddedByValue() {}
...
func RegisterRemoteTopologyServer(s grpc.ServiceRegistrar, srv RemoteTopologyServer) {
	// If the following call panics, it indicates UnimplementedRemoteTopologyServer was
...
var RemoteTopology_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "github.com/aity-cloud/monty/plugins/topology/apis/stream/stream.proto",
}
