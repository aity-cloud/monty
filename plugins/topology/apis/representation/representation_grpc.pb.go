...
func (c *topologyRepresentationClient) GetGraph(ctx context.Context, in *v1.Reference, opts ...grpc.CallOption) (*TopologyGraph, error) {
	...
	err := c.cc.Invoke(ctx, TopologyRepresentation_GetGraph_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *topologyRepresentationClient) RenderGraph(ctx context.Context, in *v1.Reference, opts ...grpc.CallOption) (*DOTRepresentation, error) {
	...
	err := c.cc.Invoke(ctx, TopologyRepresentation_RenderGraph_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedTopologyRepresentationServer should be embedded to have
...
func (UnimplementedTopologyRepresentationServer) RenderGraph(context.Context, *v1.Reference) (*DOTRepresentation, error) {
	return nil, status.Error(codes.Unimplemented, "method RenderGraph not implemented")
}
func (UnimplementedTopologyRepresentationServer) testEmbeddedByValue() {}
...
func RegisterTopologyRepresentationServer(s grpc.ServiceRegistrar, srv TopologyRepresentationServer) {
	// If the following call panics, it indicates UnimplementedTopologyRepresentationServer was
