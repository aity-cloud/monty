...
const file_github_com_aity_cloud_monty_plugins_slo_apis_slo_slo_proto_rawDesc = "" +
	"\n" +
	":github.com/aity-cloud/monty/plugins/slo/apis/slo/slo.proto\x12\x03slo\x1a\x1egoogle/protobuf/duration.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x15google/api/http.proto\x1a\x1cgoogle/api/annotations.proto\x1a7github.com/aity-cloud/monty/pkg/apis/core/v1/core.proto\x1a\x17google/rpc/status.proto\x1a?github.com/aity-cloud/monty/pkg/apis/alerting/v1/alerting.proto\x1aIgithub.com/aity-cloud/monty/pkg/apis/alerting/v1/alerting.condition.proto\x1aHgithub.com/aity-cloud/monty/pkg/apis/alerting/v1/alerting.endpoint.proto\"i\n" +
	...
	"\aPreview\x12\x15.slo.CreateSLORequest\x1a\x17.slo.SLOPreviewResponse\"\x18\x82\xd3\xe4\x93\x02\x12:\x01*\"\r/slos/previewB2Z0github.com/aity-cloud/monty/plugins/slo/apis/slob\x06proto3"

var (
	file_github_com_aity_cloud_monty_plugins_slo_apis_slo_slo_proto_rawDescOnce sync.Once
	file_github_com_aity_cloud_monty_plugins_slo_apis_slo_slo_proto_rawDescData []byte
)
...
func file_github_com_aity_cloud_monty_plugins_slo_apis_slo_slo_proto_rawDescGZIP() []byte {
	file_github_com_aity_cloud_monty_plugins_slo_apis_slo_slo_proto_rawDescOnce.Do(func() {
		file_github_com_aity_cloud_monty_plugins_slo_apis_slo_slo_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_aity_cloud_monty_plugins_slo_apis_slo_slo_proto_rawDesc), len(file_github_com_aity_cloud_monty_plugins_slo_apis_slo_slo_proto_rawDesc)))
	})
...
var file_github_com_aity_cloud_monty_plugins_slo_apis_slo_slo_proto_goTypes = []any{
...
func file_github_com_aity_cloud_monty_plugins_slo_apis_slo_slo_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_aity_cloud_monty_plugins_slo_apis_slo_slo_proto_rawDesc), len(file_github_com_aity_cloud_monty_plugins_slo_apis_slo_slo_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   30,
			NumExtensions: 0,
			NumServices:   1,
