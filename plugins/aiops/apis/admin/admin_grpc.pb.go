...
func (c *aIAdminClient) GetAISettings(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*AISettings, error) {
	...
	out := new(AISettings)
	err := c.cc.Invoke(ctx, AIAdmin_GetAISettings_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aIAdminClient) PutAISettings(ctx context.Context, in *AISettings, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, AIAdmin_PutAISettings_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aIAdminClient) DeleteAISettings(ctx context.Context, in *DeleteOptions, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, AIAdmin_DeleteAISettings_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aIAdminClient) UpgradeAvailable(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*UpgradeAvailableResponse, error) {
	...
	err := c.cc.Invoke(ctx, AIAdmin_UpgradeAvailable_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aIAdminClient) DoUpgrade(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, AIAdmin_DoUpgrade_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aIAdminClient) GetRuntimeClasses(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*RuntimeClassResponse, error) {
	...
	err := c.cc.Invoke(ctx, AIAdmin_GetRuntimeClasses_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedAIAdminServer should be embedded to have
...
func (UnimplementedAIAdminServer) PutAISettings(context.Context, *AISettings) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method PutAISettings not implemented")
}
func (UnimplementedAIAdminServer) DeleteAISettings(context.Context, *DeleteOptions) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteAISettings not implemented")
}
...
func (UnimplementedAIAdminServer) GetRuntimeClasses(context.Context, *emptypb.Empty) (*RuntimeClassResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetRuntimeClasses not implemented")
}
func (UnimplementedAIAdminServer) testEmbeddedByValue() {}
...
func RegisterAIAdminServer(s grpc.ServiceRegistrar, srv AIAdminServer) {
	// If the following call panics, it indicates UnimplementedAIAdminServer was
...
var AIAdmin_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "github.com/aity-cloud/monty/plugins/aiops/apis/admin/admin.proto",
}
