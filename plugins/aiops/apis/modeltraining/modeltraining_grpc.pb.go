...
func (c *modelTrainingClient) TrainModel(ctx context.Context, in *ModelTrainingParametersList, opts ...grpc.CallOption) (*ModelTrainingResponse, error) {
	...
	err := c.cc.Invoke(ctx, ModelTraining_TrainModel_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *modelTrainingClient) PutModelTrainingStatus(ctx context.Context, in *ModelStatus, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, ModelTraining_PutModelTrainingStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *modelTrainingClient) ClusterWorkloadAggregation(ctx context.Context, in *v1.Reference, opts ...grpc.CallOption) (*WorkloadAggregationList, error) {
	...
	err := c.cc.Invoke(ctx, ModelTraining_ClusterWorkloadAggregation_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *modelTrainingClient) GetModelStatus(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ModelStatus, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ModelStatus)
	err := c.cc.Invoke(ctx, ModelTraining_GetModelStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *modelTrainingClient) GetModelTrainingParameters(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ModelTrainingParametersList, error) {
	...
	err := c.cc.Invoke(ctx, ModelTraining_GetModelTrainingParameters_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *modelTrainingClient) GPUInfo(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GPUInfoList, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GPUInfoList)
	err := c.cc.Invoke(ctx, ModelTraining_GPUInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedModelTrainingServer should be embedded to have
...
func (UnimplementedModelTrainingServer) PutModelTrainingStatus(context.Context, *ModelStatus) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method PutModelTrainingStatus not implemented")
}
func (UnimplementedModelTrainingServer) ClusterWorkloadAggregation(context.Context, *v1.Reference) (*WorkloadAggregationList, error) {
	return nil, status.Error(codes.Unimplemented, "method ClusterWorkloadAggregation not implemented")
}
...
func (UnimplementedModelTrainingServer) GetModelTrainingParameters(context.Context, *emptypb.Empty) (*ModelTrainingParametersList, error) {
	return nil, status.Error(codes.Unimplemented, "method GetModelTrainingParameters not implemented")
}
...
func (UnimplementedModelTrainingServer) testEmbeddedByValue() {}
...
func RegisterModelTrainingServer(s grpc.ServiceRegistrar, srv ModelTrainingServer) {
	// If the following call panics, it indicates UnimplementedModelTrainingServer was
...
var ModelTraining_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "github.com/aity-cloud/monty/plugins/aiops/apis/modeltraining/modeltraining.proto",
}
