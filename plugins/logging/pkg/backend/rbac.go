...
func (b *LoggingBackend) Backend(ctx context.Context, _ *emptypb.Empty) (*proxyv1.BackendInfo, error) {
...
func (b *LoggingBackend) Path(_ context.Context, _ *emptypb.Empty) (*proxyv1.PathInfo, error) {
