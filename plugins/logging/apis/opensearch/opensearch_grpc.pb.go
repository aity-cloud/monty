...
func (c *opensearchClient) GetDetails(ctx context.Context, in *ClusterReference, opts ...grpc.CallOption) (*OpensearchDetails, error) {
	...
	err := c.cc.Invoke(ctx, Opensearch_GetDetails_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedOpensearchServer should be embedded to have
...
func (UnimplementedOpensearchServer) testEmbeddedByValue() {}
...
func RegisterOpensearchServer(s grpc.ServiceRegistrar, srv OpensearchServer) {
	// If the following call panics, it indicates UnimplementedOpensearchServer was
...
func _Opensearch_GetDetails_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Opensearch_GetDetails_FullMethodName,
	}
