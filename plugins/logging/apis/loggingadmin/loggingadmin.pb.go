...
const file_github_com_aity_cloud_monty_plugins_logging_apis_loggingadmin_loggingadmin_proto_rawDesc = "" +
	"\n" +
	"Pgithub.com/aity-cloud/monty/plugins/logging/apis/loggingadmin/loggingadmin.proto\x12\floggingadmin\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x15google/api/http.proto\x1a\x1cgoogle/api/annotations.proto\x1a\"k8s.io/api/core/v1/generated.proto\"\xb6\x04\n" +
	...
	"\x15ListSnapshotSchedules\x12\x16.google.protobuf.Empty\x1a .loggingadmin.SnapshotStatusList\"\x19\x82\xd3\xe4\x93\x02\x13\x12\x11/logging/snapshotB?Z=github.com/aity-cloud/monty/plugins/logging/apis/loggingadminb\x06proto3"

var (
	file_github_com_aity_cloud_monty_plugins_logging_apis_loggingadmin_loggingadmin_proto_rawDescOnce sync.Once
	file_github_com_aity_cloud_monty_plugins_logging_apis_loggingadmin_loggingadmin_proto_rawDescData []byte
)
...
func file_github_com_aity_cloud_monty_plugins_logging_apis_loggingadmin_loggingadmin_proto_rawDescGZIP() []byte {
	file_github_com_aity_cloud_monty_plugins_logging_apis_loggingadmin_loggingadmin_proto_rawDescOnce.Do(func() {
		file_github_com_aity_cloud_monty_plugins_logging_apis_loggingadmin_loggingadmin_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_aity_cloud_monty_plugins_logging_apis_loggingadmin_loggingadmin_proto_rawDesc), len(file_github_com_aity_cloud_monty_plugins_logging_apis_loggingadmin_loggingadmin_proto_rawDesc)))
	})
...
var file_github_com_aity_cloud_monty_plugins_logging_apis_loggingadmin_loggingadmin_proto_goTypes = []any{
...
func file_github_com_aity_cloud_monty_plugins_logging_apis_loggingadmin_loggingadmin_proto_init() {
	...
	file_github_com_aity_cloud_monty_plugins_logging_apis_loggingadmin_loggingadmin_proto_msgTypes[0].OneofWrappers = []any{}
	file_github_com_aity_cloud_monty_plugins_logging_apis_loggingadmin_loggingadmin_proto_msgTypes[1].OneofWrappers = []any{}
	file_github_com_aity_cloud_monty_plugins_logging_apis_loggingadmin_loggingadmin_proto_msgTypes[3].OneofWrappers = []any{}
	file_github_com_aity_cloud_monty_plugins_logging_apis_loggingadmin_loggingadmin_proto_msgTypes[4].OneofWrappers = []any{}
	file_github_com_aity_cloud_monty_plugins_logging_apis_loggingadmin_loggingadmin_proto_msgTypes[6].OneofWrappers = []any{}
	file_github_com_aity_cloud_monty_plugins_logging_apis_loggingadmin_loggingadmin_proto_msgTypes[7].OneofWrappers = []any{}
	file_github_com_aity_cloud_monty_plugins_logging_apis_loggingadmin_loggingadmin_proto_msgTypes[14].OneofWrappers = []any{}
	file_github_com_aity_cloud_monty_plugins_logging_apis_loggingadmin_loggingadmin_proto_msgTypes[15].OneofWrappers = []any{}
	file_github_com_aity_cloud_monty_plugins_logging_apis_loggingadmin_loggingadmin_proto_msgTypes[16].OneofWrappers = []any{}
	file_github_com_aity_cloud_monty_plugins_logging_apis_loggingadmin_loggingadmin_proto_msgTypes[17].OneofWrappers = []any{}
	file_github_com_aity_cloud_monty_plugins_logging_apis_loggingadmin_loggingadmin_proto_msgTypes[19].OneofWrappers = []any{}
	file_github_com_aity_cloud_monty_plugins_logging_apis_loggingadmin_loggingadmin_proto_msgTypes[21].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_aity_cloud_monty_plugins_logging_apis_loggingadmin_loggingadmin_proto_rawDesc), len(file_github_com_aity_cloud_monty_plugins_logging_apis_loggingadmin_loggingadmin_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   26,
			NumExtensions: 0,
			NumServices:   1,
