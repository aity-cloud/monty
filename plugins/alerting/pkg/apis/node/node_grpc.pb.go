...
func (c *nodeAlertingCapabilityClient) Sync(ctx context.Context, in *AlertingCapabilityConfig, opts ...grpc.CallOption) (*SyncResponse, error) {
	...
	err := c.cc.Invoke(ctx, NodeAlertingCapability_Sync_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedNodeAlertingCapabilityServer should be embedded to have
...
func (UnimplementedNodeAlertingCapabilityServer) testEmbeddedByValue() {}
...
func RegisterNodeAlertingCapabilityServer(s grpc.ServiceRegistrar, srv NodeAlertingCapabilityServer) {
	// If the following call panics, it indicates UnimplementedNodeAlertingCapabilityServer was
...
var NodeAlertingCapability_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "github.com/aity-cloud/monty/plugins/alerting/pkg/apis/node/node.proto",
}
...
func (c *alertingNodeConfigurationClient) GetDefaultConfiguration(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*AlertingCapabilitySpec, error) {
	...
	err := c.cc.Invoke(ctx, AlertingNodeConfiguration_GetDefaultConfiguration_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *alertingNodeConfigurationClient) SetDefaultConfiguration(ctx context.Context, in *AlertingCapabilitySpec, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, AlertingNodeConfiguration_SetDefaultConfiguration_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *alertingNodeConfigurationClient) GetNodeConfiguration(ctx context.Context, in *v1.Reference, opts ...grpc.CallOption) (*AlertingCapabilitySpec, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AlertingCapabilitySpec)
	err := c.cc.Invoke(ctx, AlertingNodeConfiguration_GetNodeConfiguration_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *alertingNodeConfigurationClient) SetNodeConfiguration(ctx context.Context, in *NodeConfigRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, AlertingNodeConfiguration_SetNodeConfiguration_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedAlertingNodeConfigurationServer should be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedAlertingNodeConfigurationServer) GetNodeConfiguration(context.Context, *v1.Reference) (*AlertingCapabilitySpec, error) {
	return nil, status.Error(codes.Unimplemented, "method GetNodeConfiguration not implemented")
}
func (UnimplementedAlertingNodeConfigurationServer) SetNodeConfiguration(context.Context, *NodeConfigRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method SetNodeConfiguration not implemented")
}
func (UnimplementedAlertingNodeConfigurationServer) testEmbeddedByValue() {}
...
func RegisterAlertingNodeConfigurationServer(s grpc.ServiceRegistrar, srv AlertingNodeConfigurationServer) {
	// If the following call panics, it indicates UnimplementedAlertingNodeConfigurationServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
