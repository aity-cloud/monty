...
func (c *ruleSyncClient) SyncRules(ctx context.Context, in *RuleManifest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, RuleSync_SyncRules_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedRuleSyncServer should be embedded to have
...
func (UnimplementedRuleSyncServer) testEmbeddedByValue() {}
...
func RegisterRuleSyncServer(s grpc.ServiceRegistrar, srv RuleSyncServer) {
	// If the following call panics, it indicates UnimplementedRuleSyncServer was
...
var RuleSync_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "github.com/aity-cloud/monty/plugins/alerting/pkg/apis/rules/rules.proto",
}
