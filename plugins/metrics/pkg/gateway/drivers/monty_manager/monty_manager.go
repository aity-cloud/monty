...
func (k MontyManagerClusterDriverOptions) newGateway() *montycorev1.Gateway {
	return &montycorev1.Gateway{
		ObjectMeta: metav1.ObjectMeta{
...
func NewMontyManagerClusterDriver(ctx context.Context, options MontyManagerClusterDriverOptions) (*MontyManager, error) {
...
func (k *MontyManager) ActiveConfigStore() storage.ValueStoreT[*cortexops.CapabilityBackendConfigSpec] {
...
func (k *MontyManager) GetCortexServiceConfig() drivers.CortexServiceConfig {
...
func (k *MontyManager) GetGrafanaServiceConfig() drivers.GrafanaServiceConfig {
...
func init() {
	drivers.ClusterDrivers.Register("monty-manager", func(ctx context.Context, opts ...driverutil.Option) (drivers.ClusterDriver, error) {
		...
		return NewMontyManagerClusterDriver(ctx, options)
	})
}
