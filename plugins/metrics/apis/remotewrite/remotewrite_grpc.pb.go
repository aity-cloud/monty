...
func (c *remoteWriteClient) Push(ctx context.Context, in *cortexpb.WriteRequest, opts ...grpc.CallOption) (*cortexpb.WriteResponse, error) {
	...
	err := c.cc.Invoke(ctx, RemoteWrite_Push_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *remoteWriteClient) SyncRules(ctx context.Context, in *Payload, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, RemoteWrite_SyncRules_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedRemoteWriteServer should be embedded to have
...
func (UnimplementedRemoteWriteServer) testEmbeddedByValue() {}
...
func RegisterRemoteWriteServer(s grpc.ServiceRegistrar, srv RemoteWriteServer) {
	// If the following call panics, it indicates UnimplementedRemoteWriteServer was
...
var RemoteWrite_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "github.com/aity-cloud/monty/plugins/metrics/apis/remotewrite/remotewrite.proto",
}
