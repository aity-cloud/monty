...
const file_github_com_aity_cloud_monty_plugins_metrics_apis_cortexadmin_cortexadmin_proto_rawDesc = "" +
	"\n" +
	"Ngithub.com/aity-cloud/monty/plugins/metrics/apis/cortexadmin/cortexadmin.proto\x12\vcortexadmin\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1cgoogle/api/annotations.proto\x1aIgithub.com/aity-cloud/monty/plugins/metrics/apis/cortexadmin/status.proto\"'\n" +
	"\aCluster\x12\x1c\n" +
	...
	"\x10ExtractRawSeries\x12\x1b.cortexadmin.MatcherRequest\x1a\x1a.cortexadmin.QueryResponse\"\x13\x82\xd3\xe4\x93\x02\r\x12\v/series/rawB>Z<github.com/aity-cloud/monty/plugins/metrics/apis/cortexadminb\x06proto3"

var (
	file_github_com_aity_cloud_monty_plugins_metrics_apis_cortexadmin_cortexadmin_proto_rawDescOnce sync.Once
	file_github_com_aity_cloud_monty_plugins_metrics_apis_cortexadmin_cortexadmin_proto_rawDescData []byte
)
...
func file_github_com_aity_cloud_monty_plugins_metrics_apis_cortexadmin_cortexadmin_proto_rawDescGZIP() []byte {
	file_github_com_aity_cloud_monty_plugins_metrics_apis_cortexadmin_cortexadmin_proto_rawDescOnce.Do(func() {
		file_github_com_aity_cloud_monty_plugins_metrics_apis_cortexadmin_cortexadmin_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_aity_cloud_monty_plugins_metrics_apis_cortexadmin_cortexadmin_proto_rawDesc), len(file_github_com_aity_cloud_monty_plugins_metrics_apis_cortexadmin_cortexadmin_proto_rawDesc)))
	})
...
var file_github_com_aity_cloud_monty_plugins_metrics_apis_cortexadmin_cortexadmin_proto_goTypes = []any{
...
func file_github_com_aity_cloud_monty_plugins_metrics_apis_cortexadmin_cortexadmin_proto_init() {
	...
	file_github_com_aity_cloud_monty_plugins_metrics_apis_cortexadmin_cortexadmin_proto_msgTypes[27].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_aity_cloud_monty_plugins_metrics_apis_cortexadmin_cortexadmin_proto_rawDesc), len(file_github_com_aity_cloud_monty_plugins_metrics_apis_cortexadmin_cortexadmin_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   37,
			NumExtensions: 0,
			NumServices:   1,
