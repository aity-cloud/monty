...
var _ = Describe("Logging MontyOpensearch Controller", Ordered, Label("controller"), func() {
	var (
		testNs string
	...
	Specify("setup", func() {
		...
		object = &loggingv1beta1.MontyOpensearch{
			...
			Spec: loggingv1beta1.MontyOpensearchSpec{
				...
				ImageRepo:         "registry.aity.tech/monty",
	...
	When("creating an monty opensearch object", func() {
		...
		It("should create a securityconfig secret", func() {
			Eventually(Object(&corev1.Secret{
				...
				HaveData("internal_users.yml", func(d string) bool {
					return strings.Contains(d, "internalmonty:")
				}),
			))
		})
		It("should create an auth secret", func() {
			Eventually(Object(&corev1.Secret{
				...
				HaveOwner(object),
				HaveData("username", "internalmonty", "password", nil),
			))
		})
	})
	When("overriding the image", func() {
		It("should update successfully", func() {
			updateObject(object, func(c *loggingv1beta1.MontyOpensearch) {
