...
import (
	...
	"github.com/aity-cloud/monty/pkg/resources/opensearchrepository"
...
// +kubebuilder:rbac:groups=logging.monty.io,resources=opensearchrepositories,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=logging.monty.io,resources=opensearchrepositories/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=logging.monty.io,resources=opensearchrepositories/finalizers,verbs=update
