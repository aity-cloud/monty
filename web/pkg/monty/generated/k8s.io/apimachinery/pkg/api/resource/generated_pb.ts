...
export class Quantity extends Message<Quantity> {
  ...
  static equals(a: Quantity | PlainMessage<Quantity> | undefined, b: Quantity | PlainMessage<Quantity> | undefined): boolean {
    return proto2.util.equals(Quantity, a, b);
  }
}
 ...
 */
export class QuantityValue extends Message<QuantityValue> {
  /**
   * @generated from field: optional string string = 1;
   */
  string?: string;

  constructor(data?: PartialMessage<QuantityValue>) {
    super();
    proto2.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto2 = proto2;
  static readonly typeName = "k8s.io.apimachinery.pkg.api.resource.QuantityValue";
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    { no: 1, name: "string", kind: "scalar", T: 9 /* ScalarType.STRING */, opt: true },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): QuantityValue {
    return new QuantityValue().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): QuantityValue {
    return new QuantityValue().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): QuantityValue {
    return new QuantityValue().fromJsonString(jsonString, options);
  }

  static equals(a: QuantityValue | PlainMessage<QuantityValue> | undefined, b: QuantityValue | PlainMessage<QuantityValue> | undefined): boolean {
    return proto2.util.equals(QuantityValue, a, b);
  }
}
