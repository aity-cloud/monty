...
import { Message, MethodOptions, proto3, ServiceOptions } from "@bufbuild/protobuf";
...
/**
 * @generated from extension: totem.QOS qos = 10001;
 */
export const qos = proto3.makeExtension<MethodOptions, QOS>(
  "totem.qos", 
  MethodOptions, 
  () => ({ no: 10001, kind: "message", T: QOS }),
);

/**
 * @generated from extension: totem.Visibility visibility = 10002;
 */
export const visibility = proto3.makeExtension<ServiceOptions, Visibility>(
  "totem.visibility", 
  ServiceOptions, 
  () => ({ no: 10002, kind: "message", T: Visibility }),
);
