...
// @generated from file github.com/aity-cloud/monty/plugins/logging/apis/loggingadmin/loggingadmin.proto (package loggingadmin, syntax proto3)
/* eslint-disable */
...
import { SnapshotStatusList } from "@pkg/monty/models/LoggingAdminV2/SnapshotStatusList";
...
export async function GetOpensearchCluster(): Promise<OpensearchClusterV2> {
  try {
    ...
    const rawResponse = (await axios.request({
      ...
      url: `/monty-api/LoggingAdminV2/logging/cluster`
    })).data;
...
export async function UpgradeAvailable(): Promise<UpgradeAvailableResponse> {
  try {
    ...
    const rawResponse = (await axios.request({
      ...
      url: `/monty-api/LoggingAdminV2/logging/upgrade/available`
    })).data;
...
export async function DoUpgrade(input: UpgradeOptions): Promise<void> {
  try {
    ...
    const rawResponse = (await axios.request({
      ...
      url: `/monty-api/LoggingAdminV2/logging/upgrade/do`,
    data: input?.toBinary() as ArrayBuffer
    })).data;
...
export async function GetStorageClasses(): Promise<StorageClassResponse> {
  try {
    ...
    const rawResponse = (await axios.request({
      ...
      url: `/monty-api/LoggingAdminV2/logging/storageclasses`
    })).data;
...
export async function GetOpensearchStatus(): Promise<StatusResponse> {
  try {
    ...
    const rawResponse = (await axios.request({
      ...
      url: `/monty-api/LoggingAdminV2/logging/status`
    })).data;
...
export async function CreateOrUpdateSnapshotSchedule(input: SnapshotSchedule): Promise<void> {
  try {
    ...
    const rawResponse = (await axios.request({
      ...
      url: `/monty-api/LoggingAdminV2/logging/snapshot`,
    data: input?.toBinary() as ArrayBuffer
    })).data;
...
export async function GetSnapshotSchedule(input: SnapshotReference): Promise<SnapshotSchedule> {
  try {
    ...
    const rawResponse = (await axios.request({
      ...
      url: `/monty-api/LoggingAdminV2/logging/snapshot/${input.name}`,
    data: input?.toBinary() as ArrayBuffer
    })).data;
