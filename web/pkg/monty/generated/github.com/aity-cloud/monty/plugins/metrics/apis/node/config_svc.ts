...
// @generated from file github.com/aity-cloud/monty/plugins/metrics/apis/node/config.proto (package node.metrics.config, syntax proto3)
/* eslint-disable */
...
export async function GetDefaultConfiguration(input: GetRequest): Promise<MetricsCapabilityConfig> {
  try {
    ...
    const rawResponse = (await axios.request({
      ...
      url: `/monty-api/NodeConfiguration/node_config`,
...
export async function ResetDefaultConfiguration(): Promise<void> {
  try {
    ...
    const rawResponse = (await axios.request({
      ...
      url: `/monty-api/NodeConfiguration/node_config/reset`
    })).data;
...
export async function GetConfiguration(input: GetRequest): Promise<MetricsCapabilityConfig> {
  try {
    ...
    const rawResponse = (await axios.request({
      ...
      url: `/monty-api/NodeConfiguration/node_config/${input.node.id}`,
    data: input?.toBinary() as ArrayBuffer
    })).data;
...
export async function ResetConfiguration(input: ResetRequest): Promise<void> {
  try {
    ...
    const rawResponse = (await axios.request({
      ...
      url: `/monty-api/NodeConfiguration/node_config/${input.node.id}/reset`,
    data: input?.toBinary() as ArrayBuffer
    })).data;
...
export async function DryRun(input: DryRunRequest): Promise<DryRunResponse> {
  try {
    ...
    const rawResponse = (await axios.request({
      ...
      url: `/monty-api/NodeConfiguration/dry-run`,
    data: input?.toBinary() as ArrayBuffer
    })).data;
...
export async function ConfigurationHistory(input: ConfigurationHistoryRequest): Promise<ConfigurationHistoryResponse> {
  try {
    ...
    const rawResponse = (await axios.request({
      ...
      url: `/monty-api/NodeConfiguration/node_config/${input.node.id}/history`,
    data: input?.toBinary() as ArrayBuffer
    })).data;
