...
// @generated from file github.com/aity-cloud/monty/plugins/metrics/apis/node/sync.proto (package node.metrics, syntax proto3)
/* eslint-disable */
...
export async function Sync(input: SyncRequest): Promise<SyncResponse> {
  try {
    ...
    const rawResponse = (await axios.request({
      ...
      url: `/monty-api/NodeMetricsCapability`,
