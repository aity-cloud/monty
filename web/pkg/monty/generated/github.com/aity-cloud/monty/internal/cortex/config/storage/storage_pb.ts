...
// @generated from file github.com/aity-cloud/monty/internal/cortex/config/storage/storage.proto (package storage, syntax proto3)
/* eslint-disable */
...
export class AzureConfig extends Message<AzureConfig> {
   ...
   *
   * @generated from field: optional string msi_resource = 6 [deprecated = true];
   * @deprecated
   */
  msiResource?: string;
   ...
   *
   * @generated from field: optional string connection_string = 10;
   */
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 10, name: "connection_string", kind: "scalar", T: 9 /* ScalarType.STRING */, opt: true },
  ]);
...
export class S3Config extends Message<S3Config> {
   ...
   *
   * @generated from field: optional string list_objects_version = 11;
   */
   ...
   *
   * @generated from field: optional bool disable_dualstack = 14;
   */
  disableDualstack?: boolean;
   ...
   *
   * @generated from field: optional bool send_content_md5 = 15;
   */
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 11, name: "list_objects_version", kind: "scalar", T: 9 /* ScalarType.STRING */, opt: true },
    { no: 14, name: "disable_dualstack", kind: "scalar", T: 8 /* ScalarType.BOOL */, opt: true },
    { no: 15, name: "send_content_md5", kind: "scalar", T: 8 /* ScalarType.BOOL */, opt: true },
  ]);
...
export class SwiftConfig extends Message<SwiftConfig> {
   ...
   *
   * @generated from field: optional string password = 22;
   */
  password?: string;
   ...
   * OpenStack Swift user's domain ID.
   *
   * @generated from field: optional string domain_id = 23;
   */
  domainId?: string;
   ...
   * OpenStack Swift user's domain name.
   *
   * @generated from field: optional string domain_name = 24;
   */
  domainName?: string;
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 22, name: "password", kind: "scalar", T: 9 /* ScalarType.STRING */, opt: true },
    { no: 23, name: "domain_id", kind: "scalar", T: 9 /* ScalarType.STRING */, opt: true },
    { no: 24, name: "domain_name", kind: "scalar", T: 9 /* ScalarType.STRING */, opt: true },
  ]);
