...
// @generated from file github.com/aity-cloud/monty/internal/codegen/cli/cli.proto (package cli, syntax proto3)
/* eslint-disable */

import type { BinaryReadOptions, FieldList, JsonReadOptions, JsonValue, PartialMessage, PlainMessage } from "@bufbuild/protobuf";
import { Any, FieldOptions, FileOptions, Message, MethodOptions, proto3, ServiceOptions } from "@bufbuild/protobuf";
...
/**
 * @generated from extension: cli.GeneratorOptions generator = 25600;
 */
export const generator = proto3.makeExtension<FileOptions, GeneratorOptions>(
  "cli.generator", 
  FileOptions, 
  () => ({ no: 25600, kind: "message", T: GeneratorOptions }),
);

/**
 * @generated from extension: cli.FlagOptions flag = 25601;
 */
export const flag = proto3.makeExtension<FieldOptions, FlagOptions>(
  "cli.flag", 
  FieldOptions, 
  () => ({ no: 25601, kind: "message", T: FlagOptions }),
);

/**
 * @generated from extension: cli.FlagSetOptions flag_set = 25602;
 */
export const flag_set = proto3.makeExtension<FieldOptions, FlagSetOptions>(
  "cli.flag_set", 
  FieldOptions, 
  () => ({ no: 25602, kind: "message", T: FlagSetOptions }),
);

/**
 * @generated from extension: cli.CommandGroupOptions command_group = 25600;
 */
export const command_group = proto3.makeExtension<ServiceOptions, CommandGroupOptions>(
  "cli.command_group", 
  ServiceOptions, 
  () => ({ no: 25600, kind: "message", T: CommandGroupOptions }),
);

/**
 * @generated from extension: cli.CommandOptions command = 25600;
 */
export const command = proto3.makeExtension<MethodOptions, CommandOptions>(
  "cli.command", 
  MethodOptions, 
  () => ({ no: 25600, kind: "message", T: CommandOptions }),
);
