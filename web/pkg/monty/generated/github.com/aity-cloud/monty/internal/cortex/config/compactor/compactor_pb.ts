...
// @generated from file github.com/aity-cloud/monty/internal/cortex/config/compactor/compactor.proto (package compactor, syntax proto3)
/* eslint-disable */
...
export class Config extends Message<Config> {
   ...
   *
   * @generated from field: optional string compaction_strategy = 18;
   */
   ...
   *
   * @generated from field: google.protobuf.Duration compaction_visit_marker_timeout = 19;
   */
  compactionVisitMarkerTimeout?: Duration;
   ...
   *
   * @generated from field: google.protobuf.Duration cleaner_visit_marker_timeout = 21;
   */
  cleanerVisitMarkerTimeout?: Duration;

  /**
   * How frequently cleaner visit marker file should be updated when cleaning user.
   *
   * @generated from field: google.protobuf.Duration cleaner_visit_marker_file_update_interval = 22;
   */
  cleanerVisitMarkerFileUpdateInterval?: Duration;
   ...
   *
   * @generated from field: optional bool caching_bucket_enabled = 24;
   */
  cachingBucketEnabled?: boolean;

  /**
   * How frequently compaction visit marker file should be updated duration compaction.
   *
   * @generated from field: google.protobuf.Duration compaction_visit_marker_file_update_interval = 25;
   */
  compactionVisitMarkerFileUpdateInterval?: Duration;
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 18, name: "compaction_strategy", kind: "scalar", T: 9 /* ScalarType.STRING */, opt: true },
    { no: 19, name: "compaction_visit_marker_timeout", kind: "message", T: Duration },
    { no: 20, name: "accept_malformed_index", kind: "scalar", T: 8 /* ScalarType.BOOL */, opt: true },
    { no: 21, name: "cleaner_visit_marker_timeout", kind: "message", T: Duration },
    { no: 22, name: "cleaner_visit_marker_file_update_interval", kind: "message", T: Duration },
    { no: 24, name: "caching_bucket_enabled", kind: "scalar", T: 8 /* ScalarType.BOOL */, opt: true },
    { no: 25, name: "compaction_visit_marker_file_update_interval", kind: "message", T: Duration },
  ]);
