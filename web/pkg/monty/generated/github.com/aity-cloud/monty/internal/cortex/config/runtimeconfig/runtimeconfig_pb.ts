...
// @generated from file github.com/aity-cloud/monty/internal/cortex/config/runtimeconfig/runtimeconfig.proto (package runtimeconfig, syntax proto3)
/* eslint-disable */
...
export class IngesterInstanceLimits extends Message<IngesterInstanceLimits> {
  ...
  /**
   * @generated from field: optional int64 max_inflight_query_requests = 5;
   */
  maxInflightQueryRequests?: bigint;
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 5, name: "max_inflight_query_requests", kind: "scalar", T: 3 /* ScalarType.INT64 */, opt: true },
  ]);
