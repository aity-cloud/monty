...
export async function getOpensearchCluster(): Promise<OpensearchClusterV2> {
  return (await axios.get('monty-api/LoggingAdminV2/logging/cluster')).data;
}

export async function deleteOpensearchCluster() {
  return (await axios.delete('monty-api/LoggingAdminV2/logging/cluster')).data;
}

export async function createOrUpdateOpensearchCluster(options: OpensearchClusterV2) {
  return (await axios.put('monty-api/LoggingAdminV2/logging/cluster', options)).data;
}

export async function upgradeAvailable(): Promise<UpgradeAvailableResponse> {
  return (await axios.get('monty-api/LoggingAdminV2/logging/upgrade/available')).data;
}

export async function doUpgrade() {
  return (await axios.post('monty-api/LoggingAdminV2/logging/upgrade/do')).data;
}

export async function getStorageClasses(): Promise<string[]> {
  return (await axios.get('monty-api/LoggingAdminV2/logging/storageclasses')).data?.storageClasses || [];
}

export async function getOpensearchStatus(): Promise <StatusResponse> {
  return (await axios.get('monty-api/LoggingAdminV2/logging/status')).data;
}

export async function createOrUpdateSnapshot(input: Snapshot) {
  return await axios.put('monty-api/LoggingAdminV2/logging/snapshot', input);
}

export async function getRecurringSnapshot(input: SnapshotReference): Promise<Snapshot> {
  return (await axios.get(`monty-api/LoggingAdminV2/logging/snapshot/${ input.name }`)).data;
}

export async function deleteSnapshot(input: SnapshotReference) {
  return (await axios.delete(`monty-api/LoggingAdminV2/logging/snapshot/${ input.name }`)).data;
}

export async function listSnapshots(): Promise<SnapshotStatusList> {
  return (await axios.get(`monty-api/LoggingAdminV2/logging/snapshot`)).data?.statuses || [];
}
