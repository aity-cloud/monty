      ...
      try {
        ...
        <div class="container">
          <ul class="heading">
            ...
            <li class="col"><strong>Severity:</strong> ${ notification.notification.properties.monty_severity }</li>
            <li class="col"><strong>Golden Signal:</strong> ${ notification.notification.properties.monty_goldenSignal }</li>
          </ul>
