...
import LoadingSpinner from '@pkg/monty/components/LoadingSpinner';
import { mapGetters } from 'vuex';
import GlobalEventBus from '@pkg/monty/utils/GlobalEventBus';
import { Capability } from '@pkg/monty/models/Capability';
import { MetricCapability } from '@pkg/monty/models/MetricCapability';
import UninstallCapabilitiesDialog from '@pkg/monty/components/dialogs/UninstallCapabilitiesDialog';
import CancelUninstallCapabilitiesDialog from '@pkg/monty/components/dialogs/CancelUninstallCapabilitiesDialog';
...
export default {
  ...
  data() {
    const headers = [
      ...
      {
        name:          'nameDisplay',
        labelKey:      'monty.tableHeaders.agentName',
  ...
  computed: { ...mapGetters({ clusters: 'monty/clusters' }) },
