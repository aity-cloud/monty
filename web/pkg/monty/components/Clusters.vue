...
import CapabilityButton from '@pkg/monty/components/CapabilityButton';
import EditClusterDialog from '@pkg/monty/components/dialogs/EditClusterDialog';
import CantDeleteClusterDialog from '@pkg/monty/components/dialogs/CantDeleteClusterDialog';
  ...
  data() {
    return {
      ...
      headers:                      [
        ...
        {
          name:          'id',
          labelKey:      'monty.tableHeaders.clusterId',
