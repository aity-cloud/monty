  ...
  data() {
    return {
      ...
      headers:          [
        ...
        {
          name:          'logs',
          labelKey:      'monty.tableHeaders.logs',
          sort:          ['logs'],
          value:         'logs',
        },
      ]
...
<template>
  ...
  <div v-else>
    <header class="mb-0">
      ...
      <a v-if="showLinkToOpensearch" href="https://monty.io/installation/monty/aiops/#consuming-ai-insights-from-monty" target="_blank" class="btn role-primary">
    ...
    <div v-else>
      <Banner v-if="!hasGpu" color="warning" class="mt-0">
        To update the watchlist a GPU must be present on the cluster. To find out how to setup a GPU on your cluster you can visit our <a href="https://monty.io/setup/gpu/" target="_blank">docs</a>.
      </Banner>
      ...
      <SortableTable
        ...
        no-rows-key="monty.workloadInsights.noRowsKey"
        :rows-per-page="15"
        @selection="selection"
      >
