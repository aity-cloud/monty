...
import { createRole } from '@pkg/monty/utils/requests/management';
  ...
  <div>
    ...
    <Tabbed :side-tabs="true" class="mb-20">
      <Tab
        name="clusters"
        c
        :label="t('monty.monitoring.role.tabs.clusters.label')"
        :weight="3"
      >
        <ArrayListSelect
          v-model="clusterIds"
          ...
          :array-list-props="{
            addLabel: t('monty.monitoring.role.tabs.clusters.add'),
          }"
        />
      </Tab>
      <Tab
        name="matchLabels"
        :label="t('monty.monitoring.role.tabs.matchLabels.label')"
        :weight="2"
      >
        <KeyValue
          v-model="matchLabels"
      ...
      <Tab
        ...
        :label="t('monty.monitoring.role.tabs.matchExpressions.label')"
        :weight="1"
      >
        <MatchExpressions
