...
<template>
  <div class="monty-roots" :class="{standalone: isStandalone()}">
    <div class="monty-root">
      <HeaderBar v-if="isStandalone()" :simple="true">
        <div class="simple-title">
          <img :src="require('../assets/images/monty.svg')" />
        </div>
      </HeaderBar>
...
<style lang="scss">
  ...
  .standalone .monty-content HEADER {
    width: 100%;
    display: flex;
    flex-direction: row;
