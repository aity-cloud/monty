...
import CloneToClustersDialog from '@pkg/monty/components/dialogs/CloneToClustersDialog';
import { InstallState, getClusterStatus, getAlertConditionsWithStatus } from '@pkg/monty/utils/requests/alerts';
import LoadingSpinnerOverlay from '@pkg/monty/components/LoadingSpinnerOverlay';
import ConditionFilter, { createDefaultFilters } from '@pkg/monty/components/ConditionFilter';
  ...
  data() {
    return {
      ...
      headers:                [
        ...
        {
          name:      'group',
          labelKey:  'monty.tableHeaders.group',
          value:     'groupDisplay'
        },
      ]
    };
